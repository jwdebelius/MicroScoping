...
ggsave('output/upset_datasources.png', bg="transparent", width=6, height=3.5, dpi=300)
```
...
ggsave("output/combinedplot1.png", bg="transparent", width = 6, height = 6, dpi = 300)
```
...
ggsave("output/upset_analysis.png", bg="transparent", width=6, height=3, dpi=300)
